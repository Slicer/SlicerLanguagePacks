...
- *Only if using Slicer-5.2.1 or earlier version:* [Download and install Qt toolkit](#download-and-install-qt-toolkit)
...
- *Only if using Slicer-5.2.1 or earlier version:* In Slicer, go to `Language Tools` module and set `Qt lrelease tool path`. It is located in the folder where Qt was installed. Default location on Windows is something like this: `c:\Qt\5.15.0\msvc2019_64\bin\lrelease.exe`
...
### Download and install Qt toolkit

. It is free. Go to [Qt website](https://www.qt.io/download-open-source), scroll down, click `Download the Qt online installer` button, and follow the instructions. Any Qt version can be used.
